...
let discoveryCredentials = vcapServices.getCredentials('SVC-Discovery');
...
if (process.env !== undefined) {
  discoveryCredentials = JSON.parse(JSON.stringify(process.env));
  discoveryUrl = discoveryCredentials['DISCOVERY_URL'];
  discoveryUsername = discoveryCredentials['DISCOVERY_USERNAME'];
  discoveryPassword = discoveryCredentials['DISCOVERY_PASSWORD'];
}
...
discovery.listCollections({ environment_id: '63989e92-e8d7-4b82-9d09-5e700f0f94df' }),
  function(error, data) {
